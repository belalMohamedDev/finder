...
class _$LoadingImpl<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'RegisterState<$T>.loading(flowState: $flowState)';
  }
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'RegisterState<$T>.error(flowState: $flowState)';
  }
...
class __$$ImagePathImplCopyWithImpl<T, $Res>
    extends _$RegisterStateCopyWithImpl<T, $Res, _$ImagePathImpl<T>>
...
class _$ImagePathImpl<T> implements ImagePath<T> {
  ...
  @override
  String toString() {
    return 'RegisterState<$T>.imagePath(imagePath: $imagePath)';
  }
...
abstract class ImagePath<T> implements RegisterState<T> {
...
class __$$ShowPasswordImplCopyWithImpl<T, $Res>
    extends _$RegisterStateCopyWithImpl<T, $Res, _$ShowPasswordImpl<T>>
...
class _$ShowPasswordImpl<T> implements ShowPassword<T> {
  ...
  @override
  String toString() {
    return 'RegisterState<$T>.showPassword(showPassword: $showPassword)';
  }
...
abstract class ShowPassword<T> implements RegisterState<T> {
