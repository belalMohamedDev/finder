...
class _$LoadingImpl<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'LoginState<$T>.loading(flowState: $flowState)';
  }
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'LoginState<$T>.error(flowState: $flowState)';
  }
...
class _$ShowPasswordImpl<T> implements ShowPassword<T> {
  ...
  @override
  String toString() {
    return 'LoginState<$T>.showPassword(showPassword: $showPassword)';
  }
